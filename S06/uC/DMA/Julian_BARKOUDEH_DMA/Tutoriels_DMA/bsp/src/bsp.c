...
void BSP_PB_IT_Init()
{
	...
	// Deactivation des resistaces de tirage Pull-up/Pull-down pour pin PC13
	...
	// Choisir le Port C comme source interruption pour la ligne interruption externe EXTI line 13
	// voir page 178 & 179
